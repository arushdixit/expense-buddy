...
export const categories: Category[] = [
  ...
  },
  {
    ...
    subcategories: ["Carrefour", "Noon", "Careem", "West Zone", "Talabat", "Amazon Now", "Grandiose", "Spinneys", "Madhoor"],
  },
  {
    id: "shopping",
    name: "Shopping",
    ...
    subcategories: ["Clothes", "Skincare", "Accessories", "Miscellaneous"],
  },
  {
    id: "entertainment",
    name: "Entertainment",
    ...
    subcategories: ["Dine-out", "Food Delivery", "Activities"],
  },
  {
    id: "utilities",
    name: "Utilities",
    ...
    subcategories: ["Cook Salary", "Internet", "DEWA", "Mobile Recharge", "Chiller"],
  },
  {
    id: "luxury",
    name: "Luxury",
